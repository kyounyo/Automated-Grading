...
context_template = """import React, { createContext, useState, useContext } from 'react';
...
output_path = os.path.abspath(os.path.join(script_dir, '../frontend/src/context/AssignmentContext.jsx'))
